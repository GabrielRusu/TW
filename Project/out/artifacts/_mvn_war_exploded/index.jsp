...
<div id="wrapper">
  ...
  <section>
    ...
    <form method="post" action="">
      <input type="text" name="text1" id="text1" size="200" value="" placeholder="Question ID"/>
      <input type="button" value="Get Question"
             onclick="callServlet('ShowSomething')"/>
      <p id="demo"></p>
    </form>

      <!--
      <h3><%=HelloWorld.yes("23")%></h3>
-->
